...
function ChatScreen({ selectedUser }) {
  ...
  const fetchChatHistory = async () => {
    try {
      const response = await axiosInstance.get(
        `/chat/chat-history?receiverId=${receiverId}&pageNumber=1&count=12`,
      );
  ...
  const bigerTablet = useMediaQuery(
              ...
              <>
                {msg?.content !== "" && (
                  <StyledListItem
                    ...
                    sx={{
                      alignSelf:
                        msg?.sendBy === "you" ? "flex-end" : "flex-start",
                      backgroundColor:
                        msg?.sendBy === "you" ? "#d9fdd3" : "#fff",
      ...
      >
        ...
        >
          ...
          <IconButton type="submit">
            <BsFillSendFill
              style={{ transform: "rotate(45deg)", color: "#ff8700" }}
            />
          </IconButton>
        </form>
      </Box>
