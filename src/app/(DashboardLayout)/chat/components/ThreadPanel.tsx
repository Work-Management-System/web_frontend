...
import { fetchThreadMessages, addOptimisticMessage } from '@/redux/features/spacesSlice';
...
export default function ThreadPanel({ parentMessageId, onClose }: ThreadPanelProps) {
